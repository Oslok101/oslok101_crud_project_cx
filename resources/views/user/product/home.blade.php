            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('user/products/create') }}" class="btn btn-primary">Registrar Producto</a>
                    </div>
                    <hr />
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="align-middle" role="group" aria-label="Basic example">
                                        <a href="{{ route('user/products/edit', ['id'=>$product->id]) }}" type="button" class="btn btn-secondary">Editar</a>
                                        <!--<a href="{{ route('admin/products/editAdmin', ['id'=>$product->id]) }}" type="button" class="btn btn-secondary">Editar</a>-->
                                        <a href="{{ route('user/products/delete', ['id'=>$product->id]) }}" type="button" class="btn btn-danger">Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                            @empty
