        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <hr />
                    <form action="{{ route('admin/products/updateAdmin', $products->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Nombre</label>
                                <input type="text" name="name" class="form-control" placeholder="Nombre" value="{{$products->name}}" disabled>
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="description" class="form-control" placeholder="Descripción" value="{{$products->description}}" disabled>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="number" name="price" class="form-control" placeholder="Precio" value="{{$products->price}}" disabled>
                                @error('price')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="date" name="purchase_date" class="form-control" placeholder="Fecha de compra" value="{{$products->purchase_date}}" disabled>
                                @error('purchase_date')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="comment" class="form-control"  value="{{$products->comment}}">
                                @error('comment')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
